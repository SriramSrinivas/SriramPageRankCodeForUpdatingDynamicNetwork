...
//Properties of the Network having the SCC & Page Rank
struct VertexProp
{
    ...
    vector<int> batchOut; //number of outsideConnnection neighbors at batch x
...
struct PR_Comp
{
    ...
    double pageRank;
    bool updateFlag;
    double pageRank_d_value_after_computation;
